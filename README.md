...
Projeto tem foco em ajudar funcionarios com neurodivergencia, ajudando elas a fazer tarefas e se organizarem.
...
## 🚀 1. Testando com Postman / Insomnia
...
▶️ 1.2 Listar Usuários (paginado)

***GET*: /api/usuario?page=0&direction=ASC&quantidadeListada=10**

▶️ 1.3 Buscar Usuário por ID

***GET* /api/usuario/1**

▶️ 1.4 Atualizar Usuário
